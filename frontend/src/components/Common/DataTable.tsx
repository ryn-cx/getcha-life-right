...
export function DataTable<TData extends { id: string }, TValue>({
  ...
  const table = useReactTable({
    ...
    getFacetedUniqueValues: getFacetedUniqueValues(), // unique values for select filter/autocomplete
    getFacetedMinMaxValues: getFacetedMinMaxValues(), // min/max values for range filter
